...
``` 
git clone https://github.com/pumpfun-tools/PumpFun-Bump-Bot.git
``` 
 
Else, you can download the repository in a zip here : https://github.com/pumpfun-tools/PumpFun-Bump-Bot/archive/refs/heads/main.zip
